...
const PROVIDERS: { id: string; label: string; description: string }[] = [
  ...
  { id: "postmark", label: "Postmark", description: "Not currently used for sending — blocked by its pending-approval domain restriction; see Gmail" },
  { id: "sendgrid", label: "SendGrid", description: "Alternative email sending provider" },
  { id: "gmail", label: "Gmail", description: "Reply capture & threading, plus outbound sending for sequence emails and approved replies" },
